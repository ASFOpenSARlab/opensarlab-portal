...
class PortalAuthenticator(Authenticator):
    ...
    async def authenticate(self, handler, data=None):
        if data:
            ...
            try:
                user_data_access: list = user_data.get("lab_access", {})
                user_data_access_lab: dict = user_data_access.get(self.lab_name, {})
                if not user_data_access_lab:
                    return None
                can_user_access_lab: bool = user_data_access_lab.get(
